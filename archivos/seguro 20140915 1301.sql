...
-- CREATE DATABASE /*!32312 IF NOT EXISTS*/ seguro;
-- USE seguro;

--
-- Table structure for table `seguro`.`barrios`
--
...
--
-- Dumping data for table `seguro`.`barrios`
--
...
--
-- Table structure for table `seguro`.`calles`
--
...
--
-- Dumping data for table `seguro`.`calles`
--
...
--
-- Table structure for table `seguro`.`cilindros`
--
...
--
-- Dumping data for table `seguro`.`cilindros`
--
...
--
-- Table structure for table `seguro`.`clientes`
--
...
--
-- Dumping data for table `seguro`.`clientes`
--
...
--
-- Table structure for table `seguro`.`coberturas`
--
...
--
-- Dumping data for table `seguro`.`coberturas`
--
...
--
-- Table structure for table `seguro`.`companias`
--
...
--
-- Dumping data for table `seguro`.`companias`
--
...
--
-- Table structure for table `seguro`.`condfiscales`
--
...
--
-- Dumping data for table `seguro`.`condfiscales`
--
...
--
-- Table structure for table `seguro`.`cuotas`
--
...
--
-- Dumping data for table `seguro`.`cuotas`
--
...
INSERT INTO `cuotas` (`nrocuota`,`nropoliza`,`monto`,`vencimiento1`,`vencimiento2`,`pago`,`fechapago`) VALUES 
 ...
 (2,'27-883620',192,'2013-12-21','2014-01-15',0,'0000-00-00'),
...
--
-- Table structure for table `seguro`.`gnc`
--
...
--
-- Dumping data for table `seguro`.`gnc`
--
...
--
-- Table structure for table `seguro`.`imagenes`
--
...
--
-- Dumping data for table `seguro`.`imagenes`
--
...
--
-- Table structure for table `seguro`.`localidades`
--
...
--
-- Dumping data for table `seguro`.`localidades`
--
...
--
-- Table structure for table `seguro`.`marcas`
--
...
--
-- Dumping data for table `seguro`.`marcas`
--
...
--
-- Table structure for table `seguro`.`modelos`
--
...
--
-- Dumping data for table `seguro`.`modelos`
--
...
--
-- Table structure for table `seguro`.`otrosriesgos`
--
...
--
-- Dumping data for table `seguro`.`otrosriesgos`
--
...
--
-- Table structure for table `seguro`.`polizas`
--
...
--
-- Dumping data for table `seguro`.`polizas`
--

/*!40000 ALTER TABLE `polizas` DISABLE KEYS */;
INSERT INTO `polizas` (`nropoliza`,`idcompanias`,`idclientes`,`patente`,`idcoberturas`,`idotrosriesgos`,`vigenciadesde`,`vigenciahasta`,`segvencimiento`,`premio`,`prima`,`cuotas`,`idformaspago`,`cbu`) VALUES 
 ('01',1,5,'BXP298',1,0,'2014-09-08','2014-12-31',15,35000,NULL,3,1,'9028'),
 ('02',1,5,'BXP298',1,0,'2014-09-08','2014-12-31',15,35000,NULL,3,1,'9028'),
 ('03',1,10,'azf345',1,0,'2014-09-08','2014-12-31',15,25000,1200,3,1,'9021'),
 ('12654-5487',1,18,'as',3,0,'2014-09-11','2014-12-31',20,32000,NULL,3,2,NULL),
 ('27-883620',2,10,'asd231',1,0,'2013-11-21','2014-05-21',15,1152,NULL,6,1,NULL);
/*!40000 ALTER TABLE `polizas` ENABLE KEYS */;


--
-- Table structure for table `seguro`.`telefonos`
--
...
--
-- Dumping data for table `seguro`.`telefonos`
--
...
--
-- Table structure for table `seguro`.`tipodocumentos`
--
...
--
-- Dumping data for table `seguro`.`tipodocumentos`
--
...
--
-- Table structure for table `seguro`.`tipos`
--
...
--
-- Dumping data for table `seguro`.`tipos`
--
...
--
-- Table structure for table `seguro`.`usos`
--
...
--
-- Dumping data for table `seguro`.`usos`
--
...
--
-- Table structure for table `seguro`.`vehiculos`
--
...
--
-- Dumping data for table `seguro`.`vehiculos`
--
