            ...
            <table class="table">
                ...
                if ($oPlanilla) {
                    foreach ($oPlanilla as $aPlanilla) {
                        ...
                        $idUsuario= $aPlanilla->get_idUsuario();    
                        ...
                        echo "<td>$_fecha</td>";
                        echo "<td>$nro</td>";
                        echo "<td><a href='vistaPreviaPlanillaBusqueda.php?idCompania=$idC&idPlanilla=$idP&nroPlanilla=$nro&fecha=$_fecha&idUsu=$idUsuario'><img src='../images/Original Size/note.png' alt='Ver Planilla' title='Ver Planilla'/></a></td></tr>";
                    }
                } else {
                    ?>
